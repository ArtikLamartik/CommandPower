...
if /i "%input%"=="$exit" goto exit
if /i "%input:~0,5%"=="$say:" goto say
if /i "%input:~0,6%"=="$open:" goto open
if /i "%input:~0,6%"=="$calc:" goto calc
if /i "%input:~0,6%"=="$stop:" goto stop
if /i "%input:~0,5%"=="$app:" goto apps
if /i "%input:~0,6%"=="$wait:" goto wait
...
set "cp_file=c:\CommandPower\Sys32\APPS\%input:~5%\%input:~5%.cp"
...
echo "clrscr" or "$clrscr" (It Will Clear The Screen)
